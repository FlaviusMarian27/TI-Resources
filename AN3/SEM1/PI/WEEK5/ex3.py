...
batch_size, num_steps = 50, 15#aici----------------------------------------------------------
...
def train(net, train_iter, vocab, lr, num_epochs, device):
    ...
    for epoch in range(num_epochs):
        ...
        if (epoch + 1) % 10 == 0:
            print(predict('time traveller', 35, net, vocab, device))#aici----------------------------------
            perplexities.append(ppl)
    print(f'perplexity {ppl:.1f}, device {str(device)}')
    print(predict('time traveller', 35, net, vocab, device))#aici------------------------------------------
    print(predict('traveller', 35, net, vocab, device))#aici-----------------------------------------------

    return perplexities

vocab_size, num_hiddens, device = len(vocab), 256, try_gpu()
num_epochs, lr = 300, 3#aici-------------------------------------------------------------------------------

num_inputs = vocab_size
gru_layer = nn.GRU(num_inputs, num_hiddens,num_layers=3)#aici----------------------------------------------
