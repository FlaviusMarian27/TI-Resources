...
num_hiddens, num_layers, dropout, batch_size, num_steps = 32, 3, 0.7, 64, 10#aici----------------------------------------
lr, num_epochs, device = 0.005, 400, try_gpu()#aici --------------------------------------------------------------------------------400
ffn_num_input, ffn_num_hiddens, num_heads = 32, 32, 4#------------------------------------------32 din mijloc
